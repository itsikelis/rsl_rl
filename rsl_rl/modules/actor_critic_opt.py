...
from rsl_rl.networks import MLP, MlpOpt, EmpiricalNormalization


class ActorCriticOpt(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        if kwargs:
            print(
                "ActorCriticOpt.__init__ got unexpected arguments, which will be ignored: "
        ...
        for obs_group in obs_groups["policy"]:
            ...
            ), "The ActorCriticOpt module only supports 1D observations."
    ...
    def act_inference(self, obs: TensorDict) -> torch.Tensor:
        ...
        obs = self.actor_obs_normalizer(obs)
        if self.state_dependent_std:
            return self.actor(obs, A, b, G, h)[..., 0, :]
        else:
            return self.actor(obs, A, b, G, h)
